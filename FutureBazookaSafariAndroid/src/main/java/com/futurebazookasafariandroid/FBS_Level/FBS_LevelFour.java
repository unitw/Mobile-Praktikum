...
import com.futurebazookasafariandroid.FBS_Monster.FBS_BobAndrews;
 ...
 * @author Marvin
 */
public class FBS_LevelFour extends FBS_AbstractLevel {

    public FBS_LevelFour(double StartX, double StartY, int schwierigkeit) {
        this.initMonsterlist();
        ArrayList<Integer> spawnlist = new ArrayList();
        for (int i = 0; i < 10+(schwierigkeit*5); i++) {
            FBS_BobAndrews rat = new FBS_BobAndrews(StartX, StartY);
